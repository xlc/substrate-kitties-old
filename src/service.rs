...
use substrate_kitties_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
	...
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/substrate_kitties_runtime_wasm.compact.wasm")
);
